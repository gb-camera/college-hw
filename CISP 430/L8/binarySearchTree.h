...
//Modifications:
//- Replaced all instances of "root" to "this->root"
//- Initialized trailCurrent in insert function to prevent potential uninitialized variable error
...
void bSearchTreeType<elemType>::insert(const elemType& insertItem)
{
    ...
    //Set trailCurrent to NULL to prevent potential uninitialization
    trailCurrent = NULL;
